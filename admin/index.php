...
$titleConnect = $DB_connect -> prepare("SELECT * FROM SiteBilgileri WHERE anahtar = :deger");
$titleConnect ->execute(array(':deger' => 'title'));
$title = $titleConnect -> fetch(PDOHelper::FETCH_ASSOC);
?>
...
<div class="page-container">
        ...
        <div class="mother-grid-inner">
            ...
            <div class="header-main">
                <div class="logo-w3-agile">
                    <h1><a href="index2.html">Pooled</a></h1>
                </div>
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index2.html">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
            <!--four-grids here-->
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu" >
                <li><a href="index2.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
